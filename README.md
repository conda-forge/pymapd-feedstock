About pymapd-feedstock
======================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/pymapd-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=891&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/pymapd-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `pymapd` can be installed with `conda`:
...
```
mamba install pymapd
```

It is possible to list all of the versions of `pymapd` available on your platform with `conda`:
...
```
mamba search pymapd --channel conda-forge
```
...
mamba repoquery search pymapd --channel conda-forge

# List packages depending on `pymapd`:
mamba repoquery whoneeds pymapd --channel conda-forge

# List dependencies of `pymapd`:
mamba repoquery depends pymapd --channel conda-forge
```
